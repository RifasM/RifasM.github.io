...
export class AboutComponent implements OnInit {
  aboutText: string[] = [
    'I always thought my dream was to be an artist, sipping coffee, walking around, ' +
      'but turns out it was just a hobby.',
    'I love connecting with new folks. I never get tired of doing' +
